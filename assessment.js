...
var thirdHero = heroes.find(hero => hero === 'batman')
...
function removeItem(arry, str) {
	return arry.filter(s => s !== str)
...
function outside(t, h, c) {
	return (
		t > 80 && h > 40 ? "I'm all sweat" :
		t < 40 && c > 60 ? "I have icecicles" :
		t > 80 && h < 40 && c < 20 ? "I'm literally in the desert" :
		t > 80 || h > 50 || c > 50 ? "Hmm, probably not" :
		"I love outside"
	)
}
...
function callerBack(holla, back) { // fn, str
	holla(back + ' back')
}
