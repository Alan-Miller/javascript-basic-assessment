...
function removeItem(arrOfStrings, string) {
	var newArr = [];
	for (var i = 0; i < arrOfStrings.length; i++) {
		if (arrOfStrings[i] !== string) {
...
function doubleTheFun(numOrString) {
...
function coderTest(personObj) {
	for (var key in personObj) {
		personObj[key] === 'Jeremy' ? personObj.lovesCode = 10 : personObj[key] === 'Brack' ? personObj.lovesCode = 0 : personObj.lovesCode = 5;
	}
}
