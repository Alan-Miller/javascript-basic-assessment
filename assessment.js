...
// 	if (param == Number(param)) {			// Catch number-pretenders and numbers
// 		return Number(param) * 2;
// 	}
// 	else {									// All non-numbers and non-number-pretenders
// 		return param + param;
// 	}
// }
...
const getValueOfProperty = (obj, key) => obj[key];
...
const makeChatMessage = (msg, author) => Object.assign({}, {message: msg, author: author, timestamp: new Date()});
...
const coderTest = (obj) => Object.assign(obj, {lovesCode: obj.name === 'Jeremy' ? 10 : obj.name === 'Brack' ? 0 : 5})
...
*/
const outside = (temp, hum, cloud) => temp > 80 && hum > 40 ? "I'm all sweat" : temp < 40 && cloud > 60 ? "I have icecicles" : temp > 80 && hum < 40 && cloud < 20 ? "I'm literally in the desert" : temp > 80 || hum > 50 || cloud > 50 ? "Hmm, probably not" : "I love outside";
...
const callerBack = (fn, str) => fn(str + ' back');
